$(function () {
    ...
    function offlinedev() {
        axios.get("../../json/homepage/system/offlinedev.json").then(function (res) {
            var offlinedevdata = res.data;
            //console.log(statusedata);
            if (offlinedevdata) {
    ...
    function devversion() {
        axios.get("../../json/homepage/system/devversion.json").then(function (res) {
            let devversiondata = res.data;
            if (devversiondata) {
                var versionyAxis = [], versiondata = [];
    ...
    //趋势分析
    function eventtrend() {
        let count = ["TodayRiskTotalCount", "SevenDayRiskTotalCount", "TodayEventTotalCount", "SevenDayEventTotalCount"],
